    ...
    >
      ...
      >
        ...
        >
          <div className="space-y-3">
            <input
              ...
              className="w-full rounded-lg border px-4 py-2 text-sm focus:border-[#6EADBC] focus:outline-none focus:ring-1 focus:ring-[#6EADBC]"
              style={{ borderColor: '#c8dfc9', color: '#4A4466' }}
              disabled={isLoading}
              required
            />
            <input
        ...
        <div className="relative flex items-center py-2">
          <div className="flex-grow border-t" style={{ borderColor: '#c8dfc9' }}></div>
          <span className="mx-4 flex-shrink-0 text-xs" style={{ color: 'rgba(74,68,102,0.45)' }}>OR</span>
          <div className="flex-grow border-t" style={{ borderColor: '#c8dfc9' }}></div>
        </div>
